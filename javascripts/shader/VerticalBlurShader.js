...
THREE.VerticalBlurShader = {
	...
	fragmentShader: [
		...
		"void main() {",
			...
			"top4 >= 0.0 ? top4 : (1.0 + top4);",
			"top4 < 1.0  ? top4 : (top4 - 1.0 );",
			"top3 >= 0.0 ? top3 : (1.0 + top3);",
			"top3 < 1.0  ? top3 : (top3 - 1.0 );",
			"top2 >= 0.0 ? top2 : (1.0 + top2);",
			"top2 < 1.0  ? top2 : (top2 - 1.0 );",
			"top1 >= 0.0 ? top1 : (1.0 + top1);",
			"top1 < 1.0  ? top1 : (top1 - 1.0 );",
			"bot1 >= 0.0 ? bot1 : (1.0 + bot1);",
			"bot1 < 1.0  ? bot1 : (bot1 - 1.0 );",
			"bot2 >= 0.0 ? bot2 : (1.0 + bot2);",
			"bot2 < 1.0  ? bot2 : (bot2 - 1.0 );",
			"bot3 >= 0.0 ? bot3 : (1.0 + bot3);",
			"bot3 < 1.0  ? bot3 : (bot3 - 1.0 );",
			"top4 >= 0.0 ? top4 : (1.0 + top4);",
			"top4 < 1.0  ? top4 : (top4 - 1.0 );",
