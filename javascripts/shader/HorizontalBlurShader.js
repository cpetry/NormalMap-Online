...
THREE.HorizontalBlurShader = {
	...
	fragmentShader: [
		...
		"void main() {",
			...
			"lef4 >= 0.0 ? lef4 : (1.0 + lef4);",
			"lef4 < 1.0  ? lef4 : (lef4 - 1.0 );",
			"lef3 >= 0.0 ? lef3 : (1.0 + lef3);",
			"lef3 < 1.0  ? lef3 : (lef3 - 1.0 );",
			"lef2 >= 0.0 ? lef2 : (1.0 + lef2);",
			"lef2 < 1.0  ? lef2 : (lef2 - 1.0 );",
			"lef1 >= 0.0 ? lef1 : (1.0 + lef1);",
			"lef1 < 1.0  ? lef1 : (lef1 - 1.0 );",
			"rig1 >= 0.0 ? rig1 : (1.0 + rig1);",
			"rig1 < 1.0  ? rig1 : (rig1 - 1.0 );",
			"rig2 >= 0.0 ? rig2 : (1.0 + rig2);",
			"rig2 < 1.0  ? rig2 : (rig2 - 1.0 );",
			"rig3 >= 0.0 ? rig3 : (1.0 + rig3);",
			"rig3 < 1.0  ? rig3 : (rig3 - 1.0 );",
			"lef4 >= 0.0 ? lef4 : (1.0 + lef4);",
			"lef4 < 1.0  ? lef4 : (lef4 - 1.0 );",
